...
add_cow() {
        if [[ -e /data/data/com.termux/files/usr/share/cowsay/cows/bash.bashrc ]]; then
                cp /data/data/com.termux/files/usr/share/cowsay/cows/bash.bashrc /data/data/com.termux/files/usr/etc/
        fi
}
